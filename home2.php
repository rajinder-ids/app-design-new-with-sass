      ...
      <div class="section product-categoery-icon" style="margin-top:40px">
         ...
         <div class="row tab-menu"  style="position: fixed;width: 100%;background: #fff;z-index: 999;text-align: center;">
            <div class="col s12 no-padding">
               <ul class="tabs">
                  ...
                  <!-- <li class="tab" style="display: none;"><a class="" href="#test1">Car</a></li> -->
                  <!--  <li class="tab"><a class="" href="#test1">Car</a></li> -->
                  <!-- Dropdown Trigger -->
            ...
            <!-- <div id="test1" class="col s12 categories-menu fadeInRight">
               <ul class="dropdown-content"style="width:100%;position: absolute;top:102px;opacity: 1;">
                 <div class="title">
                   <h4 class="top-margin">Car</h4><i class="material-icons dp48 hide-menu"><a class="black-text">close</a></i>
                 </div>
                 <div class="col s6 m6 l6">
                  <li class="waves-effect"><a href="#!" class="black-text">Commercial Vehicles</a></li>
                  <li class="waves-effect"><a href="#!" class="black-text">Spare Parts</a></li>
                  <li class="waves-effect"><a href="#!" class="black-text">Other Vehicles</a></li>
                 </div>
                 <div class="col s6 m6 l6">
                  <li class="waves-effect"><a href="#!" class="black-text">Commercial Vehicles</a></li>
                  <li class="waves-effect"><a href="#!" class="black-text">Spare Parts</a></li>
            ...
            <!--              <div id="test2" class="col s12 categories-menu fadeInRight ">
               <ul class="dropdown-content"style="width:100%;top:102px;opacity: 1;">
                  <div class="title">
                    <h4 class="top-margin">Electronic</h4><i class="material-icons dp48 hide-menu"><a class="black-text">close</a></i>
                  </div>
                  <div class="col s6 m6 l6">
                   <li class="waves-effect"><a href="#!" class="black-text">Computers & Laptops</a></li>
                   <li class="waves-effect"><a href="#!" class="black-text">Cameras & Lenses</a></li>
                   <li class="waves-effect"><a href="#!" class="black-text">Computer Accessories</a></li>
                 </div>
                 <div class="col s6 m6 l6">
                   <li class="waves-effect"><a href="#!" class="black-text">Computers & Laptops</a></li>
                   <li class="waves-effect"><a href="#!" class="black-text">Cameras & Lenses</a></li>
               ...
               <div id="test3" class="col s12 categories-menu fadeInRight">
                <ul class="dropdown-content"style="width:100%;top:102px;opacity: 1;">
                  <div class="title">
                    <h4 class="top-margin">Jobs</h4><i class="material-icons dp48 hide-menu"><a class="black-text">close</a></i>
                  </div>
                   <div class="col s6 m6 l6">
                     <li class="waves-effect"><a href="#!" class="black-text">Data entry & Back office</a></li>
                     <li class="waves-effect"><a href="#!" class="black-text">BPO & Telecaller</a></li>
                     <li class="waves-effect"><a href="#!" class="black-text">Driver</a></li>
                   </div>
                    <div class="col s6 m6 l6">
                     <li class="waves-effect"><a href="#!" class="black-text">Data entry & Back office</a></li>
                     <li class="waves-effect"><a href="#!" class="black-text">BPO & Telecaller</a></li>
               ...
               <div id="test4" class="col s12 categories-menu fadeInRight">
                <ul class="dropdown-content"style="width:100%;top:102px;opacity: 1;">
                  <div class="title">
                    <h4 class="top-margin">Property</h4><i class="material-icons dp48 hide-menu"><a class="black-text">close</a></i>
                  </div>
                  <div class="col s6 m6 l6">
                    <li class="waves-effect"><a href="#!" class="black-text">For Sale: Houses & Apartments</a></li>
                    <li class="waves-effect"><a href="#!" class="black-text">Lands & Plots</a></li>
                    <li class="waves-effect"><a href="#!" class="black-text">For Rent: Shops & Offices</a></li>
                  </div>
                  <div class="col s6 m6 l6">
                    <li class="waves-effect"><a href="#!" class="black-text">For Sale: Houses & Apartments</a></li>
                    <li class="waves-effect"><a href="#!" class="black-text">Lands & Plots</a></li>
               ...
               <div id="test5" class="col s12 categories-menu fadeInRight">
                <ul class="dropdown-content"style="width:100%;top:102px;opacity: 1;">
                  <div class="title">
                    <h4 class="top-margin">menu4</h4><i class="material-icons dp48 hide-menu"><a class="black-text">close</a></i>
                  </div>
                  <div class="col s6 m6 l6">
                   <li class="waves-effect"><a href="#!" class="black-text">menu1</a></li>
                   <li class="waves-effect"><a href="#!" class="black-text">menu2</a></li>
                   <li class="waves-effect"><a href="#!" class="black-text">menu3</a></li>
                  </div>
                  <div class="col s6 m6 l6">
                   <li class="waves-effect"><a href="#!" class="black-text">menu1</a></li>
                   <li class="waves-effect"><a href="#!" class="black-text">menu2</a></li>
               ...
               <div id="test6" class="col s12 categories-menu fadeInRight">
                <ul class="dropdown-content"style="width:100%;top:102px;opacity: 1;">
                  <div class="title">
                    <h4 class="top-margin">menu5</h4><i class="material-icons dp48 hide-menu"><a class="black-text">close</a></i>
                  </div>
                  <div class="col s6 m6 l6">
                   <li class="waves-effect"><a href="#!" class="black-text">menu1</a></li>
                   <li class="waves-effect"><a href="#!" class="black-text">menu2</a></li>
            ...
            <!--  <div id="test7" class="col s12 categories-menu fadeInRight">
               <ul class="dropdown-content"style="width:100%;top:102px;opacity: 1;">
                 <div class="title">
                   <h4 class="top-margin">menu7</h4><i class="material-icons dp48 hide-menu"><a class="black-text">close</a></i>
                 </div>
                 <div class="col s6 m6 l6">
                  <li class="waves-effect"><a href="#!" class="black-text">menu1</a></li>
                  <li class="waves-effect"><a href="#!" class="black-text">menu2</a></li>
         ...
         <div class=" fadeInRight top-sheet fixed-notification-main">
            <div class="" style="position:relative;">
               <h4 class="fixed-notification fade-out">Notification<i class="material-icons dp48"><a class="black-text">close</a></i></h4>
               <ul class="collection">
